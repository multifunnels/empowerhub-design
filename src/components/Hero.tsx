...
export const Hero = () => {
  return (
    <div className="relative min-h-[600px] flex items-center justify-center bg-gradient-to-r from-[rgba(223,234,247,1)] to-[rgba(244,248,252,1)]">
      ...
      <div className="container relative z-10 px-4 py-16 text-center">
        ...
        <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto animate-fade-up">
          Explore tailored courses designed to enhance leadership, communication, and productivity
        </p>
